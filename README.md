    ...
    <b>
        ...
        <h2 align="justify">
            <i>
                ...
                внутреннего финансового аудита. На данный момент решил сменить род деятельности и 
                учусь в Нетологии (Россия) по программе профессиональной переподготовки, по 
                специальности «Data Scientist: с нуля до middle»
            </i>
        </h2>
        <hr>
        <h3>
        ...
        <h3>
            <i>
                ...
                <ul>
                    ...
                    <li>построения датафреймов, Big Data, очистки данных, обработки данных с помощью инструментов Python;</li>
                    ...
                    <li>корреляционно-регрессионного анализа данных, построения и проверкя статистических гипотез, АБ-тестирования;</li>
