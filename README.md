<body>
    <b>
        ...
        <h2 align="justify">
            <i>
                Занимаюсь аналитикой в сфере бюджетного учета, внутреннего контроля и
                внутреннего финансового аудита. Решил сменить род деятельности и развиваться 
                в новом направлении, которое позволяет использовать накопленный профессиональный опыт в
        ...
        <p>
            ...
            <img src="https://github.com/DurinPavel/DurinPavel/blob/main/images/lightfm1.png" alt="LightFM" height="25"/>
        </p>
        <h3>
            <i>
                <ul>
